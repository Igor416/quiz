...
class Question(models.Model):
  ...
  answer1 = models.TextField('Ответ 1', blank=True)
  answer2 = models.TextField('Ответ 2', blank=True)
  answer3 = models.TextField('Ответ 3', blank=True)
  answer4 = models.TextField('Ответ 4', blank=True)
